...
- [html-webpack-harddi***REMOVED***plugin](https://github.com/jantimon/html-webpack-harddi***REMOVED***plugin) can be used to always write to disk the html file, useful when webpack-dev-server / HMR are being used
